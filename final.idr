...
isEven : FunDecl
isEven = MkFunDecl Tint Tbool (ExpIfThenElse (ExpLessThan (ExpVar (StopVar)) (ExpVal 2)) 
                                              (ExpEqual (ExpVar (StopVar)) (ExpVal 0))
                                              (ExpFuncCall (ExpSubtraction (ExpVar (StopVar)) (ExpVal 2))))


isEvenProg1 : Program
isEvenProg1 = MkProgram isEven Tbool (ExpFuncCall (ExpVal 7))

isEvenProg2 : Program
isEvenProg2 = MkProgram isEven Tbool (ExpFuncCall (ExpVal 8))
...
--evalProg fibProg'
--evalProg factProg
--evalProg isEvenProg1
--evalProg isEvenProg2
